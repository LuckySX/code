...
public class DateUtil {
    ...
    /**
     * 把秒数转换成具体的日期格式 00:00:00  小时不是日期格式
     *
     * @param format
     * @return
     */
    public static String getStringBySecond(Integer time) {
        ...
        if(time != null){
             ...
             if(hours >0){
            	 if(hours<10){
            		 stringBuffer.append("0"+hours.toString()+":") ;
            	 }else{
            		 stringBuffer.append(hours.toString()+":") ;
            	 }
             }else{
             ...
             if(minutes>0){
            	 if(minutes<10){
            		 stringBuffer.append("0"+minutes.toString()+":") ;
            	 }else{
             ...
             if(seconds<10){
            	 stringBuffer.append("0"+seconds.toString()) ;
             }else{
